...
# ----------------------------------------------------------------------------
# Bluetooth - uncomment for use, rename port name to the name used in the design
# ---------------------------------------------------------------------------- 
...
set_property -dict {PACKAGE_PIN A9	IOSTANDARD LVCMOS18 }  [get_ports {wifi_en_led_tri_o[0]   }];  # "A9.RADIO_LED0"
set_property -dict {PACKAGE_PIN B9 	IOSTANDARD LVCMOS18 }  [get_ports {bt_en_led_tri_o[0]     }];  # "B9.RADIO_LED1"

# ----------------------------------------------------------------------------
# High-speed expansion connector - uncomment for use, rename port name to the name used in the design
# ---------------------------------------------------------------------------- 
# Bank 65
...
# ----------------------------------------------------------------------------
# Fan control - uncomment for use, rename port name to the name used in the design
# ---------------------------------------------------------------------------- 
# Bank 65
#set_property -dict {PACKAGE_PIN F4	IOSTANDARD LVCMOS12 }   [get_ports {FAN_PWM                }];  # "F4.FAN_PWM"

# ----------------------------------------------------------------------------
# Low-speed expansion connector - uncomment for use, rename port name to the name used in the design
# ---------------------------------------------------------------------------- 
# Bank 65
